: # Editado por Hebttt el 08/16/2025
...
$sinLogon | Out-File -FilePath "$env:C:\Users\heber\Desktop\usuarios_sin_logon.txt"
$conLogon | Out-File -FilePath "$env:C:\Users\heber\Desktop\usuarios_con_logon.txt"
